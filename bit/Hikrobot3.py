...
def grab_img():
    ...
    while True:
        ...
        try :
            ...
            grayL = cv.GaussianBlur(grayL, (1, 1), 16)
            edges = cv.Canny(grayL, 89, 40) 
            rect1 = (100//K, 35//K, 50//K, 150//K)
            rect2 = (340//K, 35//K, 50//K, 150//K)
            ...
            # cv.circle(Image_output, (P2x_origin1,P2y_origin1), 3, (0, 0, 255), -1)
            # cv.circle(Image_output, (P2x_origin2,P2y_origin2), 3, (0, 0, 255), -1)

            # print("L",(P2x_origin1,(P2y_origin1+P2y_origin2)//2))
            # print("R",(P2x_origin2,(P2y_origin1+P2y_origin2)//2))
    ...
    # **********************************************************************************************
            ...
            crop2 = cv.bilateralFilter(crop2, 9,13,13)
    ...
    # **********************************************************************************************
        ...
        try :
            ...
            # P3
            Distance_P3 = abs(P1y_origin1-P2y_origin1)*Pixel_size
            # P2
            Distance_P2 = abs(P2x_origin1-P2x_origin2)*Pixel_size
            # P4
